...
run_once({ "sh /home/aterrien/.config/awesome/autorun.sh "}) -- entries must be separated by commas
...
globalkeys = my_table.join(
    ...
    -- X screen locker
    awful.key({ altkey, "Control" }, "r", function () os.execute(scrlocker) end,
    ...
    awful.key({ modkey, "Shift" }, "l", function () lain.util.rename_tag() end,
              {description = "rename tag", group = "tag"}),
    awful.key({ modkey, "Shift" }, "Left", function () lain.util.move_tag(-1) end,
              {description = "move tag to the left", group = "tag"}),
    awful.key({ modkey, "Shift" }, "Right", function () lain.util.move_tag(1) end,
              {description = "move tag to the righ", group = "tag"}),
    ...
    awful.key({ altkey, "Shift"   }, "r",     function () awful.tag.incmwfact( 0.05)          end,
              {description = "increase master width factor", group = "layout"}),
    awful.key({ altkey, "Shift"   }, "c",     function () awful.tag.incmwfact(-0.05)          end,
    ...
    -- Widgets popups
    awful.key({ altkey, }, "h", function () lain.widget.calendar.show(7) end),
    awful.key({ altkey, }, "c", function () if beautiful.fs then beautiful.fs.show(7) end end),
    ...
    awful.key({ modkey }, "h", function () awful.spawn.with_shell("xsel | xsel -i -b") end,

...
run_once({ "urxvtd", "unclutter -root", "feh --randomize --bg-max /home/alexandre/Wallpapers/" })
-- }}}
...
awful.util.tagnames   = { "web", "term", "dev", "docs", "media", "social", "other", "8", "9", "10"}
...
screen.connect_signal("property::geometry", function(s)
    -- Wallpaper
    awful.spawn("feh --randomize --bg-max /home/alexandre/Wallpapers/")
end)

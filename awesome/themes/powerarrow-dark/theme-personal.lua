...
theme.wallpaper                                 = os.getenv("HOME") .. "/Wallpapers/lwa.jpg"
...
theme.widget_rs_on                              = theme.dir .. "/icons/redshift_on.png"
theme.widget_rs_off                             = theme.dir .. "/icons/redshift_off.png"
...
-- Redshift
rs = wibox.widget.imagebox(theme.widget_rs_on)
lain.widget.contrib.redshift:attach(
    rs,
    function (active)
        if active then
            rs:set_image(theme.widget_rs_on)
        else
            rs:set_image(theme.widget_rs_off)
        end
    end
)
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            spr,
            arrl_ld,
            wibox.container.background(rs, theme.bg_focus),
            arrl_dl,
            volicon,
            theme.volume.widget,
            arrl_ld,
